...
import { ShipmentState } from '../models/shipment-state';
...
export class ShipmentService {
  ...
  public updateShipmentState(trackingCode: string, shipmentState: ShipmentState): Observable<boolean> {
    let url = '/' + trackingCode + '/state';

    return this.http
      .patch(this.baseResourceUrl + url, shipmentState, httpOptions)
      .map(() => {
        return true;
      })
      .pipe(
